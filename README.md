...
> Åbn denne side på [https://braaby-faaret.github.io/test/](https://braaby-faaret.github.io/test/)
...
* søg efter **https://github.com/braaby-faaret/test**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/braaby-faaret/test/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/braaby-faaret/test**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/braaby-faaret/test/raw/master/.github/makecode/blocks.png)
